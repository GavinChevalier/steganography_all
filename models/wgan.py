...
class GoodGenerator(nn.Module):
    def __init__(self, dim=64, output_dim=3*64*64):
        ...
        self.ln1 = nn.Linear(nz, self.ssize*self.ssize*8*self.dim)
...
class GoodDiscriminator(nn.Module):
    def __init__(self, dim=64):
        ...
        # self.conv1 = MyConvo2d(3, self.dim, 3, he_init = False)
        # self.rb1 = ResidualBlock(self.dim, 2*self.dim, 3, resample = 'down', hw=self.dim)
        # self.rb2 = ResidualBlock(2*self.dim, 4*self.dim, 3, resample = 'down', hw=int(self.dim))
        # self.rb3 = ResidualBlock(4*self.dim, 8*self.dim, 3, resample = 'down', hw=int(self.dim/2))
        # self.rb4 = ResidualBlock(8*self.dim, 8*self.dim, 3, resample = 'down', hw=int(self.dim/4))
        # self.rb5 = ResidualBlock(8*self.dim, 8*self.dim, 3, resample = 'down', hw=int(self.dim/8))
        # self.ln1 = nn.Linear(self.ssize*self.ssize*8*self.dim, 1)
